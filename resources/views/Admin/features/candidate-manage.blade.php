...
@section('content')
    <div class=" px-4 py-6 transition-all duration-300 bg-gray-100 lg:ml-64">
                            ...
                            <tr class="bg-white border-y dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.candidate.delete', $candidate->id) }}"
                                              method="POST"
        ...
        <div class="container border-1 border-gray-200 bg-white side mb-4 rounded-xl p-3">
            <!-- Search + Buttons -->
            <div
                class="flex flex-col items-start justify-between  bg-white gap-4 px-4 mb-4 lg:flex-row lg:items-center">
                <div class="py-6">
                    <h1 class="text-3xl font-semibold text-center text-gray-800 dark:text-white border-b-4 border-emerald-500 inline-block px-4 pb-2">
                        List of Positions
                    </h1>
                            ...
                            <tr class="bg-white border-y dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.position.delete', $positions->id) }}"
                                              method="POST"
